...
def test_authorization_log_pass(driver):
    """Проверяем стандартную авторизацю по логину и паролю"""
...
# pytest -v --driver Chrome --driver-path C:\\Users\\gelin\\PycharmProjects\\Project33.1\\webdriver\\chromedriver.exe test_authorization_log_pass.py