import time
import pytest
from settings import valid_password, valid_email, sname, name
...
def test_registration_email_old(driver):
    """Сценарий регистрации с уже существующей УЗ с email и паролем + авторизация в эту УЗ"""
...
# pytest -v --driver Chrome --driver-path C:\\Users\\gelin\\PycharmProjects\\Project33.1\\webdriver\\chromedriver.exe test_registration_email_old.py