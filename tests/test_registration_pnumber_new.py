import time
import pytest
from settings import valid_password, valid_pnumbertwo, sname, name
...
def test_registration_pnumber_new(driver):
    """Тестируем регистрацию с новым телефоном"""
    ...
    driver.find_element(By.ID, 'address').send_keys(valid_pnumbertwo)
    # Вводим пароль
...
# pytest -v --driver Chrome --driver-path C:\\Users\\gelin\\PycharmProjects\\Project33.1\\webdriver\\chromedriver.exe test_registration_pnumber_new.py