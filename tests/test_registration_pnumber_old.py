import time
import pytest
from settings import valid_password, valid_pnumber, sname, name
...
def test_registration_pnumber_new(driver):
    """Сценарий регистрации с уже существующей УЗ с телефоном и паролем + авторизация в эту УЗ"""
    ...
    driver.find_element(By.ID, 'address').send_keys(valid_pnumber)
    # Вводим пароль
    ...
    # Кликаем на кнопку войти в уже сущ УЗ
    driver.find_element(By.XPATH, '//*[@id="page-right"]/div/div[1]/div/form/div[1]/div/div/div[2]/button').click()
    time.sleep(2)
    # Вводим телефон УЗ
...
# pytest -v --driver Chrome --driver-path C:\\Users\\gelin\\PycharmProjects\\Project33.1\\webdriver\\chromedriver.exe test_registration_pnumber_old.py