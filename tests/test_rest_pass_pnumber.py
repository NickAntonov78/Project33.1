...
def test_rest_pass_pnumber(driver):
    """Сценарий восстановления пароля по телефону"""
    ...
    # Вводим новый пароль
    driver.find_element(By.ID, 'password-new').send_keys(valid_password1)
...
# pytest -v --driver Chrome --driver-path C:\\Users\\gelin\\PycharmProjects\\Project33.1\\webdriver\\chromedriver.exe test_rest_pass_pnumber.py